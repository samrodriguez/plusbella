...
class AbonoController extends Controller
{
    ...
    */
     ...
     * 
     *
     * @Route("/abono/data/listado/paquete", name="admin_abonos_paciente_data_paquete")
     */
    public function dataAbonoPaqueteAction(Request $request)
    {
...
//        $paciente['recordsFiltered']=57;
     ...
     * 
     *
     * @Route("/abono/data/listado/trat", name="admin_abonos_paciente_data_tratamiento")
     */
    public function dataAbonoTratamientoAction(Request $request)
    {
        ...
        //var_dump($id);
        $em = $this->getDoctrine()->getEntityManager();
        $expedientesTotal = $em->getRepository('DGPlusbelleBundle:Abono')->findBy(array('personaTratamiento'=>$id));

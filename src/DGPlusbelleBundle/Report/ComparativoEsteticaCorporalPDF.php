...
class ComparativoEsteticaCorporalPDF extends \FPDF_FPDF {
...
//    
    ...
    function Header(){
        ...
        $this->Cell(25, 0, utf8_decode('Comparativo de Lectura de Composición Corporal'));
        // Line break
       $this->Ln(0);
    }
...
//        $this->SetX(-35);
    ...
    // Set Titulo Reporte
    public function setTituloReporte($tituloReporte)
    {
        $this->tituloReporte = $tituloReporte;
